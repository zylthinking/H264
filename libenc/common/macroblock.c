    ...
    if( h->sh.i_type != SLICE_TYPE_I )
    {
        ...
        else
        {
         ...
         //   M128( &mv0[3*s4x4] ) = M128_ZERO;
			CLEAR_M128(&mv0[0*s4x4]);
			CLEAR_M128(&mv0[1*s4x4]);
			CLEAR_M128(&mv0[2*s4x4]);
			CLEAR_M128(&mv0[3*s4x4]);
            if( h->sh.i_type == SLICE_TYPE_B )
            {
				...
				CLEAR_M128(&mv1[0*s4x4]);
				CLEAR_M128(&mv1[1*s4x4]);
				CLEAR_M128(&mv1[2*s4x4]);
				CLEAR_M128(&mv1[3*s4x4]);
            }
        }
    }
